...
export default function SignUp() {
  ...
  const onSignupClick = () => {
    ...
    setIsLoading(true);
    const result = handleSignup(username, password);
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600">
      ...
      <div
        className={`w-full max-w-5xl transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] ${
          animatePanels ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
        }`}
      >
        <div className="grid md:grid-cols-[1.1fr_1fr] overflow-hidden rounded-3xl border border-white/15 bg-white/10 shadow-2xl backdrop-blur-2xl">
          ...
          >
            <div>
              <p className="mb-4 text-sm uppercase tracking-[0.4em] text-white/70">Start designing</p>
              <h2 className="text-4xl font-semibold leading-tight">Unlock bespoke interiors with your team</h2>
              <p className="mt-6 text-base text-white/80">
                Create an account to save inspiration boards, track client briefs, and collaborate on immersive spatial stories.
              </p>
            </div>
            <div className="flex items-center gap-3 text-white/80">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Growing a creative community since 2014</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              <h3 className="text-3xl font-semibold text-slate-900">Create account</h3>
              <p className="mt-2 text-sm text-slate-600">
                Fill in the details below to join the design workspace.
              </p>
            </div>

            {success && (
              <div
                className={`mb-6 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-medium text-emerald-600 transition-all duration-500 ease-out ${
            ...
            >
              ...
              <label className="flex items-start gap-3 text-sm text-slate-600">
                <input
                  type="checkbox"
                  className="mt-1 h-4 w-4 rounded border-slate-300 text-indigo-500 focus:border-indigo-400 focus:ring-indigo-300"
                />
                <span>
                  I agree to receive product updates and confirm that I accept the terms of service.
                </span>
              </label>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full rounded-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 py-3 text-sm font-semibold uppercase tracking-[0.4em] text-white shadow-lg transition hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-indigo-200 disabled:cursor-not-allowed disabled:opacity-60"
              >
